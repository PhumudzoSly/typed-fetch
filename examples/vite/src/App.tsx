  ...
  return (
    <main className="app">
      <section className="panel">
        ...
        <p className="lead">
          Click the button to call a random public endpoint with a matching
          endpoint key. Use this app to verify generated type narrowing in a
          plain Vite setup.
        </p>
      ...
      <section className="panel resultPanel">
        ...
        {state.kind === "loading" && (
          <p>Calling {state.scenario.endpointKey}...</p>
        )}
        {state.kind === "error" && (
          <p>
